...
% Escenario 1: Modelo de red distribuido donde la posici�n de los usuarios
% sigue un proceso de Poisson con distribuci�n uniforme.

clear all; close all;

%% Par�metros que definen el tipo de simulaci�n
...
showFig = 1;         % Mostrar figuras (asociadas a las bater�as)
n_sim = 2;           % N�mero de simulaciones
storeResults = 1;    % Guardar resultados de la simulaci�n
...
n_prim = 2;          % N�mero de usuarios primarios
