function [mean_rij, a, p_mean, Opt, V, J, C, mean_inter] = sim_alg (sim, isDistr, isBatt, showFig)
...
% El número del flujo indica su origen
src_flows = sim.src_flows;
...
if ~isDistr
    ...
    conflict_graph = Create_conflict_graph(links_norm, Graph);
end
...
%         [Sets2, N_Sets2] = Ind_Set_MWDGA(conflict_graph, phi, links_norm, links_fib);
    ...
    for m = 1:n_nodes
        ...
        for f = 1:n_flows
            ...
            a([1:src_flows(f)-1 src_flows(f)+1:end], f) = 0;
